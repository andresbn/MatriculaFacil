...
@interface AddCursoVC ()

@end

@implementation AddCursoVC

@synthesize CreditosLbl,CreditosTxt,RequisitoLbl,RequisitoTxt,CicloLbl,CicloTxt,tap,CodigoLbl,CodigoTxt,CrearBtn,NombreTxt;
...
-(void) initializeControls
{
    ...
    CrearBtn.layer.cornerRadius = 5; // this value vary as per your desire
    CrearBtn.clipsToBounds = YES;
}
